...
app.get("/museio/api/dashboard/get_dashboard", (req, res) => {
    
})

app.listen(4201, "localhost", () => {
    console.log("Museio dashboard microservice is listening on localhost:4201!");
    ...
    // let img = fs.readFileSync('/museio_profile_storage/profile.jpg');
    // program_init.connection.query("UPDATE Users set Profile_Image = ? where Email_Address = 'davidruffner924@gmail.com'", [img], (err, result) => {
    //     if (err) {
    //         console.log(err);
    //     }
    //     else {
