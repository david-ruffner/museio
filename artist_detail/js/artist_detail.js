...
$(document).ready(function() {
    ...
    let artist_id = params.find(param => param.parameter_name === "artist_id");
    if (artist_id) {
        artist_id.parameter_value = decodeURIComponent(artist_id.parameter_value);
        $("#artist_detail_title").data().artist_id = artist_id.parameter_value;
        let user_token = get_user_token();
        
        if (user_token) {
            // Call the API
            $.ajax({
                url: `https://museio.davidr.pro/museio/api/songbank/get_artist_info?artist_id=${encodeURIComponent(artist_id.parameter_value)}`,
                type: 'GET',
                ...
                success: function(result) {
                    ...
                    result.message.artist_songs.forEach(artist_song => {
                        ...
                        let letter_name = artist_song.letter_name;
                        ...
                        artist_song.songs.forEach(song => {
                            let song_display = $(
